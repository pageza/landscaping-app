terraform {
  ...
  backend "s3" {
    bucket         = "landscaping-app-terraform-state"
...
# ECS Services will be defined in separate files for better organization
# This includes API, Worker, and Web services
...
resource "aws_cloudwatch_log_group" "redis_slow" {
  ...
  tags = {
    Name = "${var.project_name}-redis-slow"
  }
}
